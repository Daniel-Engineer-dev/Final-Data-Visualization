...
\begin{itemize}
    \item **Kho mã nguồn:** Github repository của môn học tại \url{https://github.com/Daniel-Engineer-dev/Final-Data-Visualization}.
    \item **Hướng dẫn cài đặt và chạy:** Xem tệp tin \texttt{summary.md} đặt tại thư mục gốc của dự án.
    \item **Phiên bản dữ liệu Parquet:** \texttt{climate\_daily.parquet} lưu tại thư mục \texttt{data/processed/}, ngày phát hành 15/06/2026.
    \item **Nhật ký AI:** \texttt{ai\_sessions.sqlite3} lưu tại thư mục \texttt{data/logs/}.
\end{itemize}
