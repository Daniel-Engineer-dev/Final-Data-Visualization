...
\section{Gợi ý ý tưởng phân tích}
Đối với người dùng chưa xác định rõ hướng khai thác dữ liệu, phân hệ AI Analyst Portal cung cấp sẵn một danh sách chip gợi ý câu hỏi phân tích nhanh (ví dụ: so sánh lượng mưa theo mùa giữa hai địa phương, xếp hạng các trạm đo nóng nhất, hoặc kiểm tra quan hệ giữa bức xạ mặt trời và lượng mưa). Người dùng chỉ cần nhấp chọn một gợi ý để tự động điền vào ô nhập câu hỏi, giúp rút ngắn thời gian làm quen và định hướng các dạng truy vấn mà hệ thống có thể xử lý tốt trước khi tự đặt câu hỏi tùy biến.
